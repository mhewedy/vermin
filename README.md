...
```
Or in case you want to create and provision the VM: (see [sample_init_focal.sh](https://github.com/mhewedy/vermin/blob/master/etc/samples-provision/sample_init_focal.sh) for sample provision script)
```shell script
